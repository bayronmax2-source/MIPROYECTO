...
def ingresar_fecha():
    while True:
        ...
        partes = fecha.split(" ")
        if len(partes) != 2:
            print("ERROR: El formato debe ser DD/MM/AAAA HH:MM.")
            continue
...
def registrar_paciente():
    ...
    if not codigo.isalnum():
        print(
            "ERROR: El código solo puede contener "
            "letras y números, sin espacios ni signos."
        )
        return
    ...
    while True:
        ...
        if not edad_texto.isdigit():
            print(
                "ERROR: La edad debe contener solo números."
            )
            continue
        edad = int(edad_texto)
        if edad < 0 or edad > 120:
            ...
            continue
        break
    pacientes.append(Paciente(codigo, nombre, edad))
...
def buscar_por_especialidad():
    ...
    if len(encontrados) == 0:
        print(
            f"No existen médicos registrados "
            f"con la especialidad {especialidad}."
        )
    else:
...
def programar_cita():
    ...
    if codigo_cita == "":
        ...
        return
    if not codigo_cita.isalnum():
        print(
            "ERROR: El código de la cita solo puede contener "
            "letras y números, sin espacios ni signos."
        )
        return
    for cita in citas:
    ...
    if codigo_paciente == "":
        print("ERROR: El código del paciente no puede estar vacío.")
        return
    if not codigo_paciente.isalnum():
        print(
            "ERROR: El código del paciente solo puede contener "
            "letras y números, sin espacios ni signos."
        )
        return
    ...
    if codigo_medico == "":
        print("ERROR: El código del médico no puede estar vacío.")
        return
    if not codigo_medico.isalnum():
        print(
            "ERROR: El código del médico solo puede contener "
            "letras y números, sin espacios ni signos."
        )
        return
...
def registrar_atencion():
    ...
    atencion = {
        ...
        "paciente": cita_encontrada.paciente.codigo,
...
def mostrar_historial():
    ...
    for atencion in atenciones:
        if atencion["paciente"] == paciente_encontrado.codigo:
